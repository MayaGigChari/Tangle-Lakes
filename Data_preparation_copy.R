...
recapped_fish_floy_lengths<- recapped_fish_floy%>%
  ...
  left_join(lengths_data, join_by(Floy, Date_recapped_2 == Date))%>%t
...
#the absolute shortest is the round minimum, which is much shorter than thge other minimums. however, the gear can technically still catch these size fish. 
